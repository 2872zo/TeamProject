        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    <b class="logo-abbr"><img src="/images/quixlab/logo.png" alt=""> </b>
                    <span class="logo-compact"><img src="/images/quixlab/logo-compact.png" alt=""></span>
                    <span class="brand-title">
                        <img src="/images/quixlab/logo-text.png" alt="">
                    </span>
                </a>
            </div>
        </div>
                                    ...
                                    <ul>
                                        <li class="notification-unread">
                                            <a href="javascript:void()">
                                                <img class="float-left mr-3 avatar-img" src="/images/quixlab/avatar/1.jpg" alt="">
                ...
                <div class="row">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                            			 <div class="col-lg-12 text-right ">
					 						...
					 						<button type="button" class="btn btn-dark" id="save" >저장하기</button>
	       		 	 					 </div>
										<div class ="form-row">
										<div class="col-md-2">
											<br /> <br />
										...
										<div class="col-md-3">
											...
											<br /> <br /> <select name="board" size=11 class="form-control">
												...
												<c:forEach var="board" items="${boardList}">
													...
													<c:if test="${i ne 1}">
														<option class="apple"
															value="${board.boardName}/${board.boardNo}"
															id="${board.boardNo}">${board.boardName}</option>
													</c:if>

												</c:forEach>


											</select> <input type="hidden" id="totalBoardsize" value="${i}">
										</div>
											...
											<div class="boardDetail">
												...
												<c:forEach var="board" items="${boardList}">
													...
													<div class="boardDetail${j}">
														<br />
														<c:if
															test="${board.boardType=='cb100' || board.boardType=='cb101' || board.boardType=='cb103'}">
															<br />
															<h4>메뉴명</h4>
															<input type="text" class="form-control"
																name="boardName/${board.boardNo}"
																value="${board.boardName}" maxlength="6" required />
															<hr />
															...
															<div class="radio">
																<label class="radio-inline"> <input type="radio"
																	name="boardPrivate/${board.boardNo}"
																	id="optionsRadios1" value="0"
																	${board.privateFlag eq '0'.charAt(0) ? "checked" : ""}>
																	전체공개
																</label> <label class="radio-inline"> <input
																	type="radio" name="boardPrivate/${board.boardNo}"
																	id="optionsRadios2" value="1"
																	${board.privateFlag eq '1'.charAt(0) ? "checked" : ""}>
																	멤버공개
																</label>
					...
					<br />
															...
															<div class="form-inline">
																<select class="form-control" name="grade">
																	<c:forEach var="grade" items="${useGradeList}">
																		<option value="${grade.cafeGradeNo}/${board.boardNo}"
																			${grade.cafeGradeNo==board.accessGrade? "selected" : ""}>${grade.gradeName}</option>
																	</c:forEach>
																</select> 이상
															</div>
															<br />
														...
														<c:if test="${board.boardType=='cb102'}">
															<input type="hidden" name="boardName/${board.boardNo}"
																value="----------------" />
															<br />
