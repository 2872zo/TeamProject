...
<body data-theme-version="light" data-layout="vertical" data-nav-headerbg="color_1" data-headerbg="color_1" data-sidebar-style="full" data-sibebarbg="color_1" data-sidebar-position="static" data-header-position="static" data-container="wide" direction="ltr">
                            ...
                            <div class="card-body">
                                ...
                                <div class="basic-form">
                            			 <div class="col-lg-12 text-right ">
	       			 						<button type="button" class="btn btn-primary sweet-message" id="cancel">취소</button>
										...
										<div class="form-group col-md-3">
											...
											<button type="button" id="goDown" class="btn btn-primary">아래</button>
											<button type="button" id="goUp" class="btn btn-primary">위</button>
    ...
    ***********************************-->
    ...
    <script src="plugins/quixlab/sweetalert/js/sweetalert.min.js"></script>
    <script src="plugins/quixlab/sweetalert/js/sweetalert.init.js"></script>
