								...
								<br>
									<form>
										...
										<div class="form-group row">
                                            ...
                                            <div class="col-lg-8">
                                                <label class="css-control css-control-primary css-checkbox" for="val-terms">
                                                    <input type="radio" class="check" id="val-terms" name="memberNicknameFlag" value="true"> <span class="css-control-indicator"></span>카페별명</label>
                                                    <input type="radio" class="check" id="val-terms" name="memberNicknameFlag" value="false"> <span class="css-control-indicator"></span>포털닉네임</label>
                                            </div>
                                         </div><hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">                                            	
                                                <input type="text" class="form-control" id="val-username" name="applicationQuestion1" value="${cafe.applicationQuestion1}">
                                            </div>
                                        </div><hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">                                            	
                                                <input type="text" class="form-control" id="val-username" name="applicationQuestion2" value="${cafe.applicationQuestion2}">
                                            </div>
                                        </div><hr>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-lg-4">                                            	
                                                <input type="text" class="form-control" id="val-username" name="applicationQuestion3" value="${cafe.applicationQuestion3}">
                                            </div>
                                        </div><hr>
