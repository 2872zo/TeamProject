           		...
           		<div class="card">
           				...
           				<ul class="form-inline">
           					...
           					<li>
           						<div class="form-inline">
                                     ...
                                     <div class="form-check form-check-inline disabled">
                                         <label class="form-check-label">
                                             <input type="checkbox" class="form-check-input singleCheck" name="enginPhoenix" value="true" ${search.enginePhoenix ? "checked" : "" }>피닉스</label>
                                     </div>
                                 </div>
           					</li>
           				</ul>
           			...
           			<div>
						...
						<c:import url="/WEB-INF/views/common/pageNavigator.jsp">
							<c:param name="subject" value="Cafe" />
						</c:import>
						<!-- ToolBar End /////////////////////////////////////-->
           			</div>
