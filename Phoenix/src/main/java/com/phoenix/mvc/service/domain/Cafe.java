...
public class Cafe {
	...
	public String getMemberNickNameFlag() {
		return memberNickNameFlag;
	}
	public void setMemberNickNameFlag(String memberNickNameFlag) {
	...
	public String toString() {
		return "Cafe [cafeNo=" + cafeNo + ", cafeName=" + cafeName + ", cafeIcon=" + cafeIcon + ", manageUserNo="
				...
				+ ", memberNickNameFlag=" + memberNickNameFlag + ", autoApplicationAcceptFlag="
				+ autoApplicationAcceptFlag + ", closedFlag=" + closedFlag + ", members=" + members + "]";
	}
