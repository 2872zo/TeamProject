...
public class Cafe {
	...
	public String toString() {
		return "Cafe [cafeNo=" + cafeNo + ", cafeName=" + cafeName + ", cafeIcon=" + cafeIcon + ", manageUserNo="
				+ manageUserNo + ", managerNickname=" + managerNickname + ", regDate=" + regDate + ", cafeURL="
				+ cafeURL + ", cafeDetail=" + cafeDetail + ", bannerImg=" + bannerImg + ", mainImg=" + mainImg
				+ ", cafeType=" + cafeType + ", applicationDetail=" + applicationDetail + ", closeReason=" + closeReason
				...
				+ ", members=" + members + ", memberNo=" + memberNo + ", favorited=" + favorited + "]";
	}
